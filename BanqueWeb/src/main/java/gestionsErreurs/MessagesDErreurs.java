...
/**
 * This class is a container for all error messages that an {@link TraitementException} can throw.
 */
public class MessagesDErreurs {
    ...
    /**
     * Provide the message associated to the specified exception ID.
